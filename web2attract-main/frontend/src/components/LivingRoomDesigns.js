  ...
  return (
    <div className="living-room-designs-container">
      <div className="breadcrumbs">
        <a href="#Home">Home</a> / <a href="#Design">Design Ideas</a> /{" "}
      ...
      <p className="living-room-description">
        ...
        décor ideas at Livspace. We bring
        <br />
        you living room designs that are customizable, practical and trendy.
        From modular TV units to wall paintings and living
        <br />
        room wall designs, you’ll find all the inspiration you’ll need to get
        started. Browse now to zero in on your <br />
      ...
      <div className="living-room-designs">
        ...
        <div className="card1">
          <h2>
            2BHK Homes Form 3.37
            <br />
            Laks
          </h2>
          <p>
            Homes That Fit All Budgets. EMIS Starting
            <br />
            From 9k/- Month
          </p>
        ...
        <div className="card3">
          <div>
            <img
              src="https://images.livspace-cdn.com/w:1366/plain/https://d3gq2merok8n5r.cloudfront.net/bumblebee/design-ideas-1631689829-DYFFs/categories-1631797090-e35Vc/desktop-1631797104-w47JI/1518-x-1288-1648187994-4ef5H.jpg"
              className="image"
              alt="image4"
            />
          </div>
          <div className="forms">
            ...
            <form>
              ...
              <button>GET FREE QUOTE</button>
              <p>
                By Submitting this from, you agree to the
                <br />
